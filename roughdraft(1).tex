...
\raggedright
\textit{\tiny{Source: Author's calculations based on INE (2022), DEFRA (2022), and IPCC (2019) emission factors.}}
\end{table}
...
\begin{table}[h]
\caption{\small Total household carbon footprint by emission scope}\label{tab:total_emissions}
\begin{tabular}{lcccc}
\toprule
